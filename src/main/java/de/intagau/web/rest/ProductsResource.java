...
/**
 * REST controller for managing {@link de.intagau.domain.Products}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Products> result = productsRepository
            ...
            .map(existingProducts -> {
                ...
                if (products.getUrl() != null) {
                    existingProducts.setUrl(products.getUrl());
                }
                if (products.getEan() != null) {
                    existingProducts.setEan(products.getEan());
                }
