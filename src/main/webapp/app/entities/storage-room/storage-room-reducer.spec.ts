...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORAGEROOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_STORAGEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STORAGEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STORAGEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STORAGEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STORAGEROOM actions', async () => {
      const expectedActions = [
        {
