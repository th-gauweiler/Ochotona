...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOCKPOSITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_STOCKPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOCKPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOCKPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOCKPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOCKPOSITION actions', async () => {
      const expectedActions = [
        {
